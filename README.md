...
Tenho experiência com **C#, .NET, React e SQL**, trabalhando na construção e evolução de APIs, resolução de problemas em produção e aplicação de boas práticas de arquitetura como **CQRS e Clean Architecture**.
